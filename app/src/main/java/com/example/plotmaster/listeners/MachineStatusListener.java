...
public class MachineStatusListener extends BaseObservable {
    ...
    private Jogging jogging = new Jogging(0.00, DEFAULT_FEED_RATE, false);
    ...
    //*******
    public MutableLiveData<Position> observablePos = new MutableLiveData<>();
    public MutableLiveData<Boolean> observablePenPos = new MutableLiveData<>();
    ...
    private MachineStatusListener(){
        setObservable(getMachinePosition());
    ...
    private void setObservable(Position Wpos){
        observablePos.postValue(Wpos);
    }



    @Bindable
    public String getPenPosString(){return this.penDown.toString();}
    public void setPenPosString(boolean penPos){
        observablePenPos.postValue(penPos);
        this.penDown = penPos;
    }
    ...
    public void setJogging(double stepXY, double feed, boolean inches){
        Jogging jogging = new Jogging(stepXY, feed, inches);
    ...
    public static class Jogging{
        ...
        public Jogging(double stepXY, double f, boolean i){
            this.stepXY = stepXY;this.feed = f; this.inches = i;
        }
